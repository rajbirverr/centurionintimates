'use client'
// Layout Fix Version 4 - Maroon Interactive
...
const InteractiveTitle = ({ section }: { section: any }) => {
    ...
    return (
        <h2
            className="font-normal text-[36px] leading-[100%] md:text-[56px] mx-auto max-w-[300px] md:max-w-[800px] mb-12 md:mb-16 text-center cursor-pointer outline-none transition-all duration-300"
...
export default function InteractiveMaroonSets({ initialData }: FeaturedSetsSectionProps) {
            ...
            <div className="px-4 md:px-8 lg:px-12">
                <div className="max-w-[1440px] mx-auto">
                    ...
                    <div className="bg-[#FAF9F7] rounded-2xl pt-8 pb-8 md:pt-10 md:pb-12 px-6 md:px-10 overflow-hidden">
                        ...
                        {/* Transparent Background Container - Products and Button */}
